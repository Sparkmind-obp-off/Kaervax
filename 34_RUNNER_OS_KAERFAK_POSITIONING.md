...
## 3. Two Modes
### Productized
A reusable version that can serve multiple runners with defined capabilities.
...
- custom system engagement,
- optional recurring support.

These are hypotheses until validated through real customer demand.
